...
namespace SchoolManagement.Controllers
{
    ...
    public class ClassroomsController : Controller
    {
        ...
        public async Task<IActionResult> Create(int? id)
        {
            ...
            ClassRoomViewModel std = new ClassRoomViewModel()
            {
        ...
        //public async Task<IActionResult> Create([Bind("ClassroomId,Year,Section,Status,Remarks,TeacherId,GradeId")] Classroom classroom)
        //{
        ...
        [HttpPost]
        public async Task<IActionResult> EditClassroom(ClassRoomViewModel e)
        {
            if (ModelState.IsValid)
            {
                ...
                if (exist != null)
                {
                    ...
                    TempData["Message"] = "Claasroom Update successfully";
                }
                else
                {
                    int newClassroomId = 1;

                    if (await _context.Classrooms.AnyAsync())
                    {
                    ...
                    TempData["Message"] = "Claasroom Add successfully";
                }
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> Edit(int id, [Bind("ClassroomId,Year,Section,Status,Remarks,TeacherId,GradeId")] Classroom classroom)
        //{
